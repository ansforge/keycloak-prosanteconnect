...
/**
 * Copy of org.apache.http.impl.execchain.HttpResponseProxy class but with
 * public visibility :) Used by CloseableHttpClient
 */
...
public final class ClosableHttpResponse implements CloseableHttpResponse {
	...
	public static ClosableHttpResponse from(Map<String, String> headers, String body) {
		...
		var originalResponse = INSTANCE.newHttpResponse(new ProtocolVersion("HTTP", 1, 1), 200, new BasicHttpContext());
